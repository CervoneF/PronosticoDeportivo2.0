...
public class inicio {
    ...
    public static void main(String[] args) throws IOException {
    	List<String> archivoresultados = Files.readAllLines(Paths.get("C:\\Users\\mfcmd\\eclipse-workspace\\TPI2\\resultados.csv")); //lee archivo de resultados
        ...
        List<String> archivopronostico = Files.readAllLines(Paths.get("C:\\Users\\mfcmd\\eclipse-workspace\\TPI2\\pronosticos.csv"));  //lee archivo de pronosticos
